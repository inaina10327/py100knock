...
if __name__ == "__main__":
    with open("hightemp.txt", "r")as f:
        ...
        sorted_line = sorted(sorted_line, key=lambda l: l[2])

        print str(sorted_line).decode("string-escape")

# /usr/bin/python2.7 /home/sato2/py100knock1/sato/chapter2/knock18.py
